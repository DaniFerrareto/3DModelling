...
translate([1.5*dist,dist*sin(60),-3*esp])cylinder(4*esp,rrealfio,rrealfio);
translate([8.5*dist,dist*sin(60),-3*esp])cylinder(4*esp,rrealfio,rrealfio);
translate([4*dist*cos(60),6*dist*sin(60),-3*esp])cylinder(4*esp,rrealfio,rrealfio);
translate([8*dist,6*dist*sin(60),-3*esp])cylinder(4*esp,rrealfio,rrealfio);