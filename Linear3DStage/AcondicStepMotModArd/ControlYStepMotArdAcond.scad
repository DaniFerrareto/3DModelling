...
translate([peDx+basex+2*espParede+folga1,peDy-folga1,peDz+espParede])
rotate([0,0,-90])
andorinha(2*peDy,30,peDy*(1.4/2),2*peDy,(2/3)*peDy,peDz+espParede,folga1,1);
translate([peDx+basex+2*espParede+folga1,basey+2*espParede-peDy+folga1+2*peDy,peDz+espParede])
rotate([0,0,-90])
andorinha(2*peDy,30,peDy*(1.4/2),2*peDy,(2/3)*peDy,peDz+espParede,folga1,1);
/*
