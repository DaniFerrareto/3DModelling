...
difference(){
    ...
    #translate([2,2,-4])cube([39,39,5]);    
    #translate([(37.55+4)/2,(39+4)/2,-9])cylinder(5+9,6.4/2,6.4/2,$fn=res);
}

difference(){
    translate([-2-0.15,6.4+1+4+0.5,5])cube([39+4+4+0.3,39+4-(6.4+1+4+0.5)+2+0.15,5]);
    #translate([2,2,-4])cube([39,39,5]);    
    #translate([(37.55+4)/2,(39+4)/2,-9])cylinder(5+9+10,6.4/2,6.4/2,$fn=res);
}

translate([-2-0.15,6.4+1+4+0.5,3])cube([2,39+4-(6.4+1+4+0.5)+2,2]);
translate([39+4+0.15,6.4+1+4+0.5,3])cube([2,39+4-(6.4+1+4+0.5)+2,2]);
translate([-2,39+4+0.15,3])cube([39+4+4,2,2]);
