module MontagemDoCubo(){
    ...
    difference(){
    rotate([0,90,0]) cylinder(h=15.5, r1=15,r2=15);
        rotate([0,90,0]) #cylinder(h=15.5, r1=12.5,r2=12.5);
    ...
    rotate(a=[10,0,0])#translate([12,0,-15]) cube([3.5,1,30]);
      ...
      rotate(a=[80,0,0]){
        ...
        rotate(a=[0,90,0]){translate([-62,25,25]){ 
        difference(){
    rotate([0,90,0]) cylinder(h=1, r1=25,r2=25);
        rotate([0,90,0]) #cylinder(h=14.5, r1=12.5,r2=12.5);
    }
    ...
    rotate(a=[10,0,0])#translate([12,0,-15]) cube([3.5,1,30]);
      ...
      rotate(a=[80,0,0]){
        ...
        rotate(a=[0,0,90]){translate([-12,-25,25]){ 
        difference(){
    rotate([0,90,0]) cylinder(h=1, r1=25,r2=25);
        rotate([0,90,0]) #cylinder(h=14.5, r1=12.5,r2=12.5);
    }
    ...
    rotate(a=[10,0,0])#translate([12,0,-15]) cube([3.5,1,30]);
      ...
      rotate(a=[80,0,0]){
        ...
        rotate(a=[0,0,180]){translate([-62,-25,25]){ 
        difference(){
    rotate([0,90,0]) cylinder(h=1, r1=25,r2=25);
        rotate([0,90,0]) #cylinder(h=14.5, r1=12.5,r2=12.5);
    }
    ...
    rotate(a=[10,0,0])#translate([12,0,-15]) cube([3.5,1,30]);
      ...
      rotate(a=[80,0,0]){
        ...
        rotate(a=[90,180,90]){translate([-62,-25,25]){ 
        difference(){
    rotate([0,90,0]) cylinder(h=1, r1=25,r2=25);
        rotate([0,90,0]) #cylinder(h=14.5, r1=12.5,r2=12.5);
    }
    ...
    rotate(a=[10,0,0])#translate([12,0,-15]) cube([3.5,1,30]);
      ...
      rotate(a=[80,0,0]){
        ...
        rotate(a=[0,270,180]){translate([-12,-25,25]){ 
        difference(){
    rotate([0,90,0]) cylinder(h=1, r1=25,r2=25);
        rotate([0,90,0]) #cylinder(h=14.5, r1=12.5,r2=12.5);
    }
